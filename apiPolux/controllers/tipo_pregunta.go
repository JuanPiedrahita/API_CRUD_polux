...
// TipoPreguntaController operations for TipoPregunta
type TipoPreguntaController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoPreguntaController) URLMapping() {
...
func (c *TipoPreguntaController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoPregunta(&v); err == nil {
...
// Put ...
// @Title Put
// @Description update the TipoPregunta
