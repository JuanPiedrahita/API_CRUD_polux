...
CREATE TABLE polux.estudiante_trabajo_grado(
	id serial NOT NULL,
	codigo_estudiante character varying(15) NOT NULL,
	trabajo_grado integer NOT NULL,
...
-- object: fk_estado_espacio_academico_inscrito_espacio_academico_i_4814 | type: CONSTRAINT --
-- ALTER TABLE polux.espacio_academico_inscrito DROP CONSTRAINT IF EXISTS fk_estado_espacio_academico_inscrito_espacio_academico_i_4814 CASCADE;
ALTER TABLE polux.espacio_academico_inscrito ADD CONSTRAINT fk_estado_espacio_academico_inscrito_espacio_academico_i_4814 FOREIGN KEY (estado_espacio_academico_inscrito)
